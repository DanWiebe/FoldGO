...
For custom annotation one has to provide GO id -> Gene id list. One of the common formats for gene annotation is GAF. FoldGO provides simple and convinient parser for annotation presented in GAF format. It takes only one argument: file - full path to GAF file.
```{r gafread, eval=FALSE}
...
```{r gaf_getters chunk 1, eval = FALSE}
getVersion(gaf)
```
